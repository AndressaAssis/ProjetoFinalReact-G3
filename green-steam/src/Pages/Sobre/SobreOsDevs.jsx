      ...
      <div className={styles.containerDev}>
        ...
        <div className={styles.listaDesenvolvedores}>
          ...
          <div className={styles.desenvolvedor}>
            ...
            <p>
              <strong>Qualidades e Expertises:</strong>Cria animações e
              transições que tornam a navegação pelos jogos mais envolvente.
            </p>
          </div>
          ...
          <div className={styles.desenvolvedor}>
            ...
            <h2>Luiz Fernando</h2>
            <p>
              <strong>Qualidades e Expertises:</strong> Garante que a página de
              games seja inclusiva para todos os jogadores.
            </p>
          </div>
          ...
          <div className={styles.desenvolvedor}>
            ...
            <p>
              <strong>Qualidades e Expertises:</strong> Assegura uma
              visualização impecável da loja de games em qualquer dispositivo.
            </p>
          </div>
          ...
          <div className={styles.desenvolvedor}>
            ...
            <h2>Tiago Ventura</h2>
            <p>
              <strong>Qualidades e Expertises:</strong> Cria componentes
              reutilizáveis que facilitam o lançamento de novos jogos na loja.
            </p>
          </div>
          ...
          <div className={styles.desenvolvedor}>
            ...
            <p>
              <strong>Qualidades e Expertises:</strong>Testa rigorosamente cada
              componente para uma navegação sem falhas na loja de games.{" "}
            </p>
          </div>
        </div>
      </div>
